...
from FIXXSPAM import BOT0, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, SUDOERS, ECHOUSER
from resources.data import GROUP, FIXXSPAM
  ...
  if event.sender_id in SUDOERS:
     if event.reply_to_msg_id is not None:
            ...
            if int(user_id) in FIXXSPAM:
                    text = "**ᴄᴀɴɴᴏᴛ ᴇᴄʜᴏ ᴏɴ ᴠᴀꜱʜᴜ x ꜰɪx -ꜱᴘᴀᴍʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀꜱ !**"
